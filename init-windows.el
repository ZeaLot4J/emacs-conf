...
(custom-set-variables
 ...
 '(jdee-jdk-registry
   (quote
    (("1.8.0_161" . "C:\\Program Files\\Java\\jdk1.8.0_161"))))
 '(package-selected-packages
   (quote
    (ace-jump-mode ace-jump zoutline youdao-dictionary yasnippet-snippets web-mode use-package smooth-scrolling smartparens projectile neotree multiple-cursors magit js2-mode jdee iedit hydra htmlize expand-region counsel company cider ahungry-theme ace-window))))
(custom-set-faces
